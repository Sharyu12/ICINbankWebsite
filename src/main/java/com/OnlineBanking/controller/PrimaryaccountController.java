...
//http://localhost:8080/api/v1/getAllPrimaryaccount
	...
	// http://localhost:8080/api/v1/GET:/Savingaccount/1
			@GetMapping("/GET:/Primaryaccount/{Id}")
			public ResponseEntity<Primaryaccount> getPrimaryaccountById(@PathVariable("Id") int Id )
					throws ResourceNotFoundException {
				
				Primaryaccount s = sService.getPrimaryaccount(Id);
