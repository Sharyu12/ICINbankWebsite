...
public class Primaryaccount {
	...
	public Primaryaccount(int a_no,Date date,String name,String address ,int phone,int pincode, String b_name,int b_code ,String b_address,int micr_code,int ifsc_code) {
		super();
		this.a_no = a_no;
		this.date = date;
		this.name = name;
